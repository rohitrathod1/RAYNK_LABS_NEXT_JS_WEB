      ...
      <div className="section-container">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
          <motion.div
            ...
            className="relative min-h-[380px] overflow-hidden rounded-[2rem] border border-white/10 bg-muted shadow-[0_24px_90px_-40px_rgba(15,23,42,0.9)] lg:min-h-[600px]"
          >
            ...
            <div className="absolute inset-x-5 bottom-5 rounded-2xl border border-white/10 bg-black/35 px-5 py-4 backdrop-blur-xl sm:inset-x-6 sm:bottom-6">
          ...
          >
            ...
            <div className="relative pl-8">
              <div className="absolute left-[11px] top-2 h-[calc(100%-1rem)] w-px bg-gradient-to-b from-primary/80 via-primary/30 to-transparent" />
                ...
                {timeline.map((phase, index) => {
                  ...
                  return (
                    <motion.li
                      ...
                      className={`group relative rounded-2xl border px-5 py-4 transition duration-300 ${
                        isActive
                    ...
                    >
                      <span
                        className={`absolute left-[-25px] top-6 flex h-4 w-4 items-center justify-center rounded-full border transition ${
                          isActive
                      ...
                      <p className="mt-2 line-clamp-3 text-sm leading-6 text-muted-foreground">{phase.excerpt}</p>
                    </motion.li>
                  );
                })}
              </ol>
